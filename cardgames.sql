...
--
-- Host: localhost    Database: cardgames
-- ------------------------------------------------------
...
CREATE TABLE `equipements` (
  ...
  `bonus_vie` int DEFAULT NULL,
  `bonus_attaque` int DEFAULT NULL,
  `bonus_defense` int DEFAULT NULL,
  `bonus_vitesse` int DEFAULT NULL,
  `personnage_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `personnage_id` (`personnage_id`),
  CONSTRAINT `equipements_ibfk_1` FOREIGN KEY (`personnage_id`) REFERENCES `personnages` (`id`)
...
INSERT INTO `personnages` VALUES (1,'Berserker',115,0),(2,'Snowqueen',100,10);
...
-- Dump completed on 2024-11-06 13:58:30
